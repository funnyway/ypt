...
<link rel="Shortcut Icon" href="https://passport.58.com/pic2/images/favicon.ico" type="image/x-icon" />
<script src="https://passport.58.com/static_js/js/5_1/jquery1.3.2_v0.js" type="text/javascript"></script>
<script src="https://passport.58.com/static_js/ppt/js/5_1/comm_js/boot_passport_version_v0.js" type="text/javascript"></script>
<link rel="stylesheet" href="https://passport.58.com/static_css/ppt/ui6/my/css/login_6_v20150127134112.css" type="text/css" /><link rel="stylesheet" href="https://passport.58.com/static_css/ppt/ui6/my/css/login_6_v0.css" type="text/css" />
<style>
.porleft p {
 height: 35px;
}
...
<body>
	<div id="header" class="win1000">
		<a id="logo" href="/ppt"><img alt="中文最大生活信息门户" src="https://passport.58.com/pic2/ui6/my/images/logo-49h.gif" /></a>
	...
	<div class="cb win1000">
		...
		<div class="porleft">
			<input type="hidden" name="ptk" id="ptk" value="34a8b150fc8d4985be5ca3daf0fbf960"/>
			<input type="hidden" name="cd" id="cd" value="7882"/>
			            <div class="regMenu">
               <!-- <span id="mobileRegTab"><a href="javascript:void(0);" onclick="cur_tab='phone';clickLog('from=reg_'+cur_tab);">手机注册</a></span> -->
               <span id="regTab"><a href="javascript:void(0);" onclick="cur_tab='mail';clickLog('from=reg_'+cur_tab);">邮箱注册</a></span>
               <span id="loginTab">已有账号？<a href="https://passport.58.com/login/">去登录</a></span>
            </div>
            <div class="regWrap">
				<div id="origReg" style="display:none;">
                <!-- 邮箱注册 -->
                <div  id="regCon">
                    <p>
               ...
               <div id="passwordCon">
				...
				<div id="verifyCode" >
                    <p>
                        ...
                        <input class="inp inw" id="validatecode" maxlength="5" name="validatecode" size="2" type="text"><img align="absmiddle" onclick="refreshValidatecode(); return false" name="vcodeImg" id="vcodeImg" style="cursor: pointer; height: 32px;" src="/validatecode?temp=123i1knr04o"><a onclick="refreshValidatecode(); return false" href="javascript:void(0)" class="f12">看不清？</a>
				...
				<div id="mobileCodeCon">
					...
					<p>
						...
						<input type="text" size="20" value=""  maxlength="6" class="inp inw" id="mobilecode" name="mobilecode" />
                ...
                <p class="submitwrap">
                    <span class="regtlx">&nbsp;</span>
                    <label id="butt" class="butt"><input type="submit" class="btns" value="立即注册" checked="checked" id="btnSubmit" style="width:110px;height:34px;" onclick="clickLog('from=reg_'+cur_tab+'_submit');" /></label>
                    <span id="gologin"><span id="loginOpt">已有账号？<a href="https://passport.58.com/login/">去登录</a></span></span><span id="pre"><a herf="javascript:;">返回上一步</a></span>
                </p>
...
<script type="text/javascript">
	var showSugTime;
	var timespan = 1425008499886 - new Date().getTime();
	var passporttimeout;
	...
	$(function() {
        ...
        $("#nickName").formValidator({ onfocus: "4-20位，可由汉字、数字、字母和“_”组成，注册成功后用户名不可修改" }).inputValidator({ onerror: "您还没有输入用户名" }).functionValidator({ fun: function(val, elem) {
        	...
        	console.info($.c.user.reg);return false;
